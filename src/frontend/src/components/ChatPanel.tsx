...
export default function ChatPanel() {
  ...
  useEffect(() => {
    ...
    const reloadForUser = () => {
      ...
      setUserDisplayName(
        u ? localStorage.getItem(`sentry_display_name_${u}`) || u : "",
      );
    };
    window.addEventListener("sentry_user_changed", reloadForUser);
    return () => {
      ...
      window.removeEventListener("sentry_user_changed", reloadForUser);
    };
  }, []);
