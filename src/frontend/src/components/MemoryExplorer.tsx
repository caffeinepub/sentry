...
import { Brain, Cpu, Search, Trash2 } from "lucide-react";
          ...
          <div className="px-3 pb-3 space-y-1.5">
            {filtered.map((item, idx) => (
              <button
                ...
                type="button"
                className="group flex gap-2 p-2.5 rounded border border-border hover:border-gold/30 cursor-pointer transition-all w-full text-left"
              ...
              >
                ...
                <Button
                  variant="ghost"
                  size="icon"
                  className="w-6 h-6 opacity-0 group-hover:opacity-100 text-muted-foreground hover:text-destructive shrink-0 mt-0.5"
                  onClick={(e) => {
                    e.stopPropagation();
                    handleDelete(item);
                  }}
